...
part of 'jam_submission.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

JamSubmission _$JamSubmissionFromJson(Map<String, dynamic> json) =>
    $checkedCreate('JamSubmission', json, ($checkedConvert) {
      $checkKeys(
        json,
        requiredKeys: const [
          'contentId',
...
Map<String, dynamic> _$JamSubmissionToJson(JamSubmission instance) =>
    <String, dynamic>{
