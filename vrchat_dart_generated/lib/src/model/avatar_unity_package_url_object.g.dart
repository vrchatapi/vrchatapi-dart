...
class _$AvatarUnityPackageUrlObject extends AvatarUnityPackageUrlObject {
  ...
  factory _$AvatarUnityPackageUrlObject(
      ...
      (new AvatarUnityPackageUrlObjectBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'AvatarUnityPackageUrlObject')
...
class AvatarUnityPackageUrlObjectBuilder
  ...
  @override
  AvatarUnityPackageUrlObject build() => _build();

  _$AvatarUnityPackageUrlObject _build() {
    final _$result = _$v ??
