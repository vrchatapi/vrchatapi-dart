    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        ...
        final val = ProductListing(
          ...
          listingType: $checkedConvert('listingType',
          ...
          priceTokens:
              $checkedConvert('priceTokens', (v) => (v as num).toInt()),
          productIds: $checkedConvert('productIds',
          ...
          storeIds: $checkedConvert('storeIds',
              (v) => (v as List<dynamic>).map((e) => e as String).toList()),
...
Map<String, dynamic> _$ProductListingToJson(ProductListing instance) =>
    <String, dynamic>{
      ...
      'listingVariants':
          instance.listingVariants.map((e) => e.toJson()).toList(),
