...
TiliaStatus _$TiliaStatusFromJson(Map<String, dynamic> json) => $checkedCreate(
      ...
      ($checkedConvert) {
        ...
        final val = TiliaStatus(
          ...
          economyState:
              $checkedConvert('economyState', (v) => (v as num?)?.toInt()),
          plannedOfflineWindowStart: $checkedConvert(
              'plannedOfflineWindowStart',
              (v) => v == null ? null : DateTime.parse(v as String)),
          plannedOfflineWindowEnd: $checkedConvert('plannedOfflineWindowEnd',
              (v) => v == null ? null : DateTime.parse(v as String)),
        );
        return val;
      },
...
Map<String, dynamic> _$TiliaStatusToJson(TiliaStatus instance) =>
    <String, dynamic>{
      ...
      if (instance.plannedOfflineWindowStart?.toIso8601String()
          case final value?)
