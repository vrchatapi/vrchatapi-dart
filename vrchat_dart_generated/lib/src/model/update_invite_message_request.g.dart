...
class _$UpdateInviteMessageRequest extends UpdateInviteMessageRequest {
  ...
  factory _$UpdateInviteMessageRequest(
      ...
      (new UpdateInviteMessageRequestBuilder()..update(updates)).build();

  _$UpdateInviteMessageRequest._({required this.message}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        message, 'UpdateInviteMessageRequest', 'message');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('UpdateInviteMessageRequest')
          ..add('message', message))
        .toString();
  }
}
...
class UpdateInviteMessageRequestBuilder
  ...
  @override
  _$UpdateInviteMessageRequest build() {
    final _$result = _$v ??
