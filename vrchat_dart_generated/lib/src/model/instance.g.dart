...
Instance _$InstanceFromJson(
  ...
  final val = Instance(
    ...
    contentSettings: $checkedConvert(
      'contentSettings',
      (v) => InstanceContentSettings.fromJson(v as Map<String, dynamic>),
    ),
...
Map<String, dynamic> _$InstanceToJson(Instance instance) => <String, dynamic>{
  ...
  'full': instance.full,
  if (instance.gameServerVersion case final value?) 'gameServerVersion': value,
  'id': instance.id,
  ...
  if (instance.hasCapacityForYou case final value?) 'hasCapacityForYou': value,
