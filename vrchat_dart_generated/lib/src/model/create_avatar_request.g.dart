...
class _$CreateAvatarRequest extends CreateAvatarRequest {
  @override
  ...
  @override
  CreateAvatarRequest rebuild(
          void Function(CreateAvatarRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  CreateAvatarRequestBuilder toBuilder() =>
      new CreateAvatarRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is CreateAvatarRequest &&
...
class CreateAvatarRequestBuilder
    implements Builder<CreateAvatarRequest, CreateAvatarRequestBuilder> {
  _$CreateAvatarRequest? _$v;
  ...
  CreateAvatarRequestBuilder() {
    CreateAvatarRequest._defaults(this);
  }

  CreateAvatarRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(CreateAvatarRequest other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$CreateAvatarRequest;
  }

  @override
  void update(void Function(CreateAvatarRequestBuilder)? updates) {
