    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        ...
        final val = APIConfigReportReasons(
          ...
          botting: $checkedConvert('botting',
              (v) => ReportReason.fromJson(v as Map<String, dynamic>)),
          cancellation: $checkedConvert('cancellation',
              (v) => ReportReason.fromJson(v as Map<String, dynamic>)),
          copyright: $checkedConvert(
              'copyright',
              (v) => v == null
                  ? null
                  : ReportReason.fromJson(v as Map<String, dynamic>)),
          fraud: $checkedConvert(
              ...
              (v) => v == null
                  ...
                  : ReportReason.fromJson(v as Map<String, dynamic>)),
          gore: $checkedConvert(
              'gore', (v) => ReportReason.fromJson(v as Map<String, dynamic>)),
          hacking: $checkedConvert('hacking',
              (v) => ReportReason.fromJson(v as Map<String, dynamic>)),
          harassing: $checkedConvert('harassing',
              (v) => ReportReason.fromJson(v as Map<String, dynamic>)),
          hateful: $checkedConvert('hateful',
              (v) => ReportReason.fromJson(v as Map<String, dynamic>)),
          impersonation: $checkedConvert('impersonation',
              (v) => ReportReason.fromJson(v as Map<String, dynamic>)),
          inappropriate: $checkedConvert('inappropriate',
              (v) => ReportReason.fromJson(v as Map<String, dynamic>)),
          leaking: $checkedConvert('leaking',
              (v) => ReportReason.fromJson(v as Map<String, dynamic>)),
          malicious: $checkedConvert('malicious',
              (v) => ReportReason.fromJson(v as Map<String, dynamic>)),
          missing: $checkedConvert('missing',
              (v) => ReportReason.fromJson(v as Map<String, dynamic>)),
          nudity: $checkedConvert('nudity',
              (v) => ReportReason.fromJson(v as Map<String, dynamic>)),
          renewal: $checkedConvert('renewal',
              (v) => ReportReason.fromJson(v as Map<String, dynamic>)),
          security: $checkedConvert('security',
              (v) => ReportReason.fromJson(v as Map<String, dynamic>)),
          service: $checkedConvert('service',
              (v) => ReportReason.fromJson(v as Map<String, dynamic>)),
          sexual: $checkedConvert('sexual',
              (v) => ReportReason.fromJson(v as Map<String, dynamic>)),
          technical: $checkedConvert(
              ...
              (v) => v == null
                  ? null
                  : ReportReason.fromJson(v as Map<String, dynamic>)),
          threatening: $checkedConvert('threatening',
              (v) => ReportReason.fromJson(v as Map<String, dynamic>)),
          visuals: $checkedConvert('visuals',
              (v) => ReportReason.fromJson(v as Map<String, dynamic>)),
        );
        return val;
      },
...
Map<String, dynamic> _$APIConfigReportReasonsToJson(
    ...
    <String, dynamic>{
      ...
      if (instance.fraud?.toJson() case final value?) 'fraud': value,
      ...
      if (instance.technical?.toJson() case final value?) 'technical': value,
