...
class _$InlineObject11 extends InlineObject11 {
  ...
  factory _$InlineObject11([void Function(InlineObject11Builder)? updates]) =>
      (new InlineObject11Builder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'InlineObject11')
...
class InlineObject11Builder
  ...
  @override
  InlineObject11 build() => _build();

  _$InlineObject11 _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'InlineObject11', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
