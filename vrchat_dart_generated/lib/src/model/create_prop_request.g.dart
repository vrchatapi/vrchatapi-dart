...
part of 'create_prop_request.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CreatePropRequest _$CreatePropRequestFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('CreatePropRequest', json, ($checkedConvert) {
  $checkKeys(
    json,
    requiredKeys: const [
      'assetUrl',
...
Map<String, dynamic> _$CreatePropRequestToJson(CreatePropRequest instance) =>
    <String, dynamic>{
