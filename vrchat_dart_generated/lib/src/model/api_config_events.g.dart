...
APIConfigEvents _$APIConfigEventsFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('APIConfigEvents', json, ($checkedConvert) {
  $checkKeys(
    json,
    requiredKeys: const [
      'distanceClose',
  ...
  final val = APIConfigEvents(
    distanceClose: $checkedConvert('distanceClose', (v) => (v as num).toInt()),
    distanceFactor: $checkedConvert(
      'distanceFactor',
      (v) => (v as num).toInt(),
    ),
    distanceFar: $checkedConvert('distanceFar', (v) => (v as num).toInt()),
    groupDistance: $checkedConvert('groupDistance', (v) => (v as num).toInt()),
    maximumBunchSize: $checkedConvert(
      'maximumBunchSize',
      (v) => (v as num).toInt(),
    ),
    notVisibleFactor: $checkedConvert(
      'notVisibleFactor',
      (v) => (v as num).toInt(),
    ),
    ...
    playerOrderFactor: $checkedConvert(
      'playerOrderFactor',
      (v) => (v as num).toInt(),
    ),
