...
class _$InlineObject10 extends InlineObject10 {
  ...
  factory _$InlineObject10([void Function(InlineObject10Builder)? updates]) =>
      (new InlineObject10Builder()..update(updates))._build();
  ...
  _$InlineObject10._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(name, r'InlineObject10', 'name');
    BuiltValueNullFieldError.checkNotNull(
        imageUrl, r'InlineObject10', 'imageUrl');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'InlineObject10')
...
class InlineObject10Builder
  ...
  @override
  InlineObject10 build() => _build();

  _$InlineObject10 _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'InlineObject10', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
