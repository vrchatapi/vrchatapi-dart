...
class _$FileUploadURL extends FileUploadURL {
  ...
  factory _$FileUploadURL([void Function(FileUploadURLBuilder)? updates]) =>
      (new FileUploadURLBuilder()..update(updates))._build();

  _$FileUploadURL._({required this.url}) : super._() {
    BuiltValueNullFieldError.checkNotNull(url, r'FileUploadURL', 'url');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'FileUploadURL')..add('url', url))
        .toString();
  }
}
...
class FileUploadURLBuilder
  ...
  @override
  FileUploadURL build() => _build();

  _$FileUploadURL _build() {
    final _$result = _$v ??
        new _$FileUploadURL._(
            url: BuiltValueNullFieldError.checkNotNull(
                url, r'FileUploadURL', 'url'));
    replace(_$result);
    return _$result;
  }
}
