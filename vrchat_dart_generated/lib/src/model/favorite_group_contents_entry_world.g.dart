...
part of 'favorite_group_contents_entry_world.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

FavoriteGroupContentsEntryWorld _$FavoriteGroupContentsEntryWorldFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('FavoriteGroupContentsEntryWorld', json, ($checkedConvert) {
  $checkKeys(
    json,
    requiredKeys: const [
      'authorName',
...
Map<String, dynamic> _$FavoriteGroupContentsEntryWorldToJson(
  FavoriteGroupContentsEntryWorld instance,
) => <String, dynamic>{
