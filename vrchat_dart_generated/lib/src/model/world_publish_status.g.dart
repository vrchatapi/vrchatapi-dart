...
class _$WorldPublishStatus extends WorldPublishStatus {
  ...
  factory _$WorldPublishStatus(
      ...
      (new WorldPublishStatusBuilder()..update(updates)).build();

  _$WorldPublishStatus._({required this.canPubilsh}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        canPubilsh, 'WorldPublishStatus', 'canPubilsh');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('WorldPublishStatus')
