...
Product _$ProductFromJson(Map<String, dynamic> json) => $checkedCreate(
      ...
      ($checkedConvert) {
        ...
        final val = Product(
          ...
          groupAccess:
              $checkedConvert('groupAccess', (v) => v as bool? ?? false),
          groupAccessRemove:
              $checkedConvert('groupAccessRemove', (v) => v as bool? ?? false),
          groupId: $checkedConvert('groupId', (v) => v as String?),
          groupRoleId: $checkedConvert('groupRoleId', (v) => v as String?),
          id: $checkedConvert('id', (v) => v as String),
          imageId: $checkedConvert('imageId', (v) => v as String),
          parentListings: $checkedConvert('parentListings',
              (v) => (v as List<dynamic>).map((e) => e as String).toList()),
          productType: $checkedConvert(
              'productType', (v) => $enumDecode(_$ProductTypeEnumMap, v)),
          sellerDisplayName:
              $checkedConvert('sellerDisplayName', (v) => v as String),
          sellerId: $checkedConvert('sellerId', (v) => v as String),
          tags: $checkedConvert('tags',
              (v) => (v as List<dynamic>).map((e) => e as String).toList()),
          updated: $checkedConvert(
              'updated', (v) => v == null ? null : DateTime.parse(v as String)),
          useForSubscriberList: $checkedConvert(
              'useForSubscriberList', (v) => v as bool? ?? false),
        );
        return val;
      },
    );
...
Map<String, dynamic> _$ProductToJson(Product instance) => <String, dynamic>{
      ...
      if (instance.groupAccessRemove case final value?)
        'groupAccessRemove': value,
