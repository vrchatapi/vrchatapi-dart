...
Map<String, dynamic> _$APIConfigToJson(APIConfig instance) => <String, dynamic>{
  ...
  if (instance.clientNetInThread case final value?) 'clientNetInThread': value,
  ...
  if (instance.devLanguageCodes case final value?) 'devLanguageCodes': value,
  ...
  if (instance.economyPauseStart case final value?) 'economyPauseStart': value,
