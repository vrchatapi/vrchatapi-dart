...
class _$UpdateFavoriteGroupRequest extends UpdateFavoriteGroupRequest {
  ...
  factory _$UpdateFavoriteGroupRequest(
      ...
      (new UpdateFavoriteGroupRequestBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('UpdateFavoriteGroupRequest')
...
class UpdateFavoriteGroupRequestBuilder
  ...
  @override
  _$UpdateFavoriteGroupRequest build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'UpdateFavoriteGroupRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
