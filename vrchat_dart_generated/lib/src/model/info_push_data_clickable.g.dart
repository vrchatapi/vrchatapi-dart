...
class _$InfoPushDataClickable extends InfoPushDataClickable {
  ...
  factory _$InfoPushDataClickable(
      ...
      (new InfoPushDataClickableBuilder()..update(updates)).build();

  _$InfoPushDataClickable._({required this.command, this.parameters})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        command, 'InfoPushDataClickable', 'command');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('InfoPushDataClickable')
          ..add('command', command)
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'InfoPushDataClickable', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
