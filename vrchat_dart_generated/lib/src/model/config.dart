...
/// * [disableEventStream] - Toggles if Analytics should be disabled (this sreportedly not used in the Client)
...
abstract class Config implements Built<Config, ConfigBuilder> {
  ...
  ConfigDownloadUrls get downloadUrls;

  /// Array of DynamicWorldRow objects, used by the game to display the list of world rows
  @BuiltValueField(wireName: r'dynamicWorldRows')
  BuiltSet<ConfigDynamicWorldRows> get dynamicWorldRows;

  @BuiltValueField(wireName: r'events')
  ConfigEvents get events;
  ...
  Iterable<Object?> serialize(Serializers serializers, Config object,
    ...
    result
      ...
      ..add(serializers.serialize(object.announcements,
          specifiedType:
              const FullType(BuiltSet, [FullType(ConfigAnnouncements)])));
    result
      ..add(r'apiKey')
    ...
    result
      ...
      ..add(serializers.serialize(object.downloadUrls,
          specifiedType: const FullType(ConfigDownloadUrls)));
    result
      ..add(r'dynamicWorldRows')
      ..add(serializers.serialize(object.dynamicWorldRows,
          specifiedType:
              const FullType(BuiltSet, [FullType(ConfigDynamicWorldRows)])));
    result
      ..add(r'events')
      ..add(serializers.serialize(object.events,
          specifiedType: const FullType(ConfigEvents)));
    result
      ...
      switch (key) {
        ...
        case r'announcements':
          result.announcements.replace(serializers.deserialize(value,
                  specifiedType:
                      const FullType(BuiltSet, [FullType(ConfigAnnouncements)]))
              as BuiltSet<ConfigAnnouncements>);
          break;
        case r'apiKey':
        ...
        case r'downloadUrls':
          result.downloadUrls.replace(serializers.deserialize(value,
                  specifiedType: const FullType(ConfigDownloadUrls))
              as ConfigDownloadUrls);
          break;
        case r'dynamicWorldRows':
          result.dynamicWorldRows.replace(serializers.deserialize(value,
                  specifiedType: const FullType(
                      BuiltSet, [FullType(ConfigDynamicWorldRows)]))
              as BuiltSet<ConfigDynamicWorldRows>);
          break;
        case r'events':
          result.events.replace(serializers.deserialize(value,
              specifiedType: const FullType(ConfigEvents)) as ConfigEvents);
          break;
