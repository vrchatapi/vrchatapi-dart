...
APIConfigMinSupportedClientBuildNumber
    _$APIConfigMinSupportedClientBuildNumberFromJson(
        ...
        $checkedCreate(
          ...
          ($checkedConvert) {
            ...
            final val = APIConfigMinSupportedClientBuildNumber(
              appStore: $checkedConvert('AppStore',
                  (v) => PlatformBuildInfo.fromJson(v as Map<String, dynamic>)),
              default_: $checkedConvert('Default',
                  (v) => PlatformBuildInfo.fromJson(v as Map<String, dynamic>)),
              firebase: $checkedConvert('Firebase',
                  (v) => PlatformBuildInfo.fromJson(v as Map<String, dynamic>)),
              firebaseiOS: $checkedConvert('FirebaseiOS',
                  (v) => PlatformBuildInfo.fromJson(v as Map<String, dynamic>)),
              googlePlay: $checkedConvert('GooglePlay',
                  (v) => PlatformBuildInfo.fromJson(v as Map<String, dynamic>)),
              PC: $checkedConvert('PC',
                  (v) => PlatformBuildInfo.fromJson(v as Map<String, dynamic>)),
              picoStore: $checkedConvert('PicoStore',
                  (v) => PlatformBuildInfo.fromJson(v as Map<String, dynamic>)),
              questAppLab: $checkedConvert('QuestAppLab',
                  (v) => PlatformBuildInfo.fromJson(v as Map<String, dynamic>)),
              questStore: $checkedConvert('QuestStore',
                  (v) => PlatformBuildInfo.fromJson(v as Map<String, dynamic>)),
              testFlight: $checkedConvert('TestFlight',
                  (v) => PlatformBuildInfo.fromJson(v as Map<String, dynamic>)),
              xRElite: $checkedConvert('XRElite',
                  (v) => PlatformBuildInfo.fromJson(v as Map<String, dynamic>)),
            );
            return val;
          },
