...
class _$InlineResponse401 extends InlineResponse401 {
  ...
  factory _$InlineResponse401(
      ...
      (new InlineResponse401Builder()..update(updates)).build();

  _$InlineResponse401._({required this.error}) : super._() {
    BuiltValueNullFieldError.checkNotNull(error, 'InlineResponse401', 'error');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('InlineResponse401')
          ..add('error', error))
        .toString();
  }
}
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'InlineResponse401', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
