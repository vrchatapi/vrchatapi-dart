...
class _$ConfigEvents extends ConfigEvents {
  ...
  factory _$ConfigEvents([void Function(ConfigEventsBuilder)? updates]) =>
      (new ConfigEventsBuilder()..update(updates)).build();
  ...
  _$ConfigEvents._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        distanceClose, 'ConfigEvents', 'distanceClose');
    BuiltValueNullFieldError.checkNotNull(
        distanceFactor, 'ConfigEvents', 'distanceFactor');
    BuiltValueNullFieldError.checkNotNull(
        distanceFar, 'ConfigEvents', 'distanceFar');
    BuiltValueNullFieldError.checkNotNull(
        groupDistance, 'ConfigEvents', 'groupDistance');
    BuiltValueNullFieldError.checkNotNull(
        maximumBunchSize, 'ConfigEvents', 'maximumBunchSize');
    BuiltValueNullFieldError.checkNotNull(
        notVisibleFactor, 'ConfigEvents', 'notVisibleFactor');
    BuiltValueNullFieldError.checkNotNull(
        playerOrderBucketSize, 'ConfigEvents', 'playerOrderBucketSize');
    BuiltValueNullFieldError.checkNotNull(
        playerOrderFactor, 'ConfigEvents', 'playerOrderFactor');
    BuiltValueNullFieldError.checkNotNull(
        slowUpdateFactorThreshold, 'ConfigEvents', 'slowUpdateFactorThreshold');
    BuiltValueNullFieldError.checkNotNull(
        viewSegmentLength, 'ConfigEvents', 'viewSegmentLength');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('ConfigEvents')
    ...
    final _$result = _$v ??
        new _$ConfigEvents._(
            ...
            playerOrderFactor: BuiltValueNullFieldError.checkNotNull(
                playerOrderFactor, 'ConfigEvents', 'playerOrderFactor'),
            slowUpdateFactorThreshold: BuiltValueNullFieldError.checkNotNull(slowUpdateFactorThreshold, 'ConfigEvents', 'slowUpdateFactorThreshold'),
            viewSegmentLength: BuiltValueNullFieldError.checkNotNull(viewSegmentLength, 'ConfigEvents', 'viewSegmentLength'));
    replace(_$result);
    return _$result;
  }
}
