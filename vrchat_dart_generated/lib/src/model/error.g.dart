...
class _$Error extends Error {
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('Error')..add('error', error))
        .toString();
  }
}
...
class ErrorBuilder implements Builder<Error, ErrorBuilder> {
  ...
  ResponseBuilder? _error;
  ResponseBuilder get error => _$this._error ??= new ResponseBuilder();
  ...
  _$Error build() {
    _$Error _$result;
    try {
      _$result = _$v ?? new _$Error._(error: _error?.build());
    } catch (_) {
