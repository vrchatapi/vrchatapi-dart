...
class AuthenticationApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [Disable2FAResult] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Disable2FAResult>> cancelPending2FA({
    ...
    Disable2FAResult? _responseData;
    ...
    return Response<Disable2FAResult>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [id] - Target user for which to verify email.
  /// * [verifyEmail] - Token to verify email.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AvatarModerationCreated] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AvatarModerationCreated>> createGlobalAvatarModeration({
    required CreateAvatarModerationRequest createAvatarModerationRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/auth/user/avatarmoderations';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    try {
      _bodyData = jsonEncode(createAvatarModerationRequest);
    } catch (error, stackTrace) {
      throw DioException(
    ...
    AvatarModerationCreated? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<AvatarModerationCreated, AvatarModerationCreated>(
              rawData,
    ...
    return Response<AvatarModerationCreated>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [targetAvatarId] - Must be a valid avatar ID.
  /// * [avatarModerationType] - The avatar moderation type associated with the avatar.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [OkStatus2] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OkStatus2>> deleteGlobalAvatarModeration({
    required String targetAvatarId,
    required AvatarModerationType avatarModerationType,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    OkStatus2? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<OkStatus2, OkStatus2>(
              rawData,
              'OkStatus2',
              growable: true,
            );
  ...
  /// Returns a [Future] containing a [Response] with a [Disable2FAResult] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Disable2FAResult>> disable2FA({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [Pending2FAResult] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Pending2FAResult>> enable2FA({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    Pending2FAResult? _responseData;
    ...
    return Response<Pending2FAResult>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [List<AvatarModeration>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<AvatarModeration>>> getGlobalAvatarModerations({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    List<AvatarModeration>? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<List<AvatarModeration>, AvatarModeration>(
              rawData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [TwoFactorRecoveryCodes] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TwoFactorRecoveryCodes>> getRecoveryCodes({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    TwoFactorRecoveryCodes? _responseData;
  ...
  /// Returns a [Future] containing a [Response] with a [Success] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Success>> resendEmailConfirmation({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  ///
  /// Parameters:
  /// * [token] - Token to verify login attempt.
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> verifyLoginPlace({
  ...
  /// Returns a [Future] containing a [Response] with a [Verify2FAResult] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Verify2FAResult>> verifyPending2FA({
    required TwoFactorAuthCode twoFactorAuthCode,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
