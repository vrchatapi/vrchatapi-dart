...
class InventoryApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [InventoryConsumptionResults] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InventoryConsumptionResults>> consumeOwnInventoryItem({
    ...
    final _path = r'/inventory/{inventoryItemId}/consume'.replaceAll(
      '{'
      r'inventoryItemId'
      '}',
    ...
    InventoryConsumptionResults? _responseData;
    ...
    try {
      ...
      _responseData = rawData == null
          ...
          : deserialize<
              ...
              InventoryConsumptionResults
            >(rawData, 'InventoryConsumptionResults', growable: true);
    ...
    return Response<InventoryConsumptionResults>(
      data: _responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InventoryItem>> equipOwnInventoryItem({
    required String inventoryItemId,
    ...
    final _path = r'/inventory/{inventoryItemId}/equip'.replaceAll(
      '{'
      r'inventoryItemId'
      '}',
      inventoryItemId.toString(),
    ...
    try {
      _bodyData = jsonEncode(equipInventoryItemRequest);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<String>>> getInventoryCollections({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/inventory/collections';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
  ...
  /// Returns a [Future] containing a [Response] with a [InventoryItem] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InventoryItem>> getUserInventoryItem({
    ...
    final _path = r'/user/{userId}/inventory/{inventoryItemId}'
        .replaceAll(
          '{'
          r'userId'
          '}',
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [List<RewardRedemptionResult>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<RewardRedemptionResult>>> redeemReward({
    required RewardRedemptionRequest rewardRedemptionRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      _bodyData = jsonEncode(rewardRedemptionRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
    ...
    List<RewardRedemptionResult>? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<List<RewardRedemptionResult>, RewardRedemptionResult>(
              rawData,
    ...
    return Response<List<RewardRedemptionResult>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [inventoryItemId] - Selector for inventory slot management.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> unequipOwnInventorySlot({
    required InventoryEquipSlot inventoryItemId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
