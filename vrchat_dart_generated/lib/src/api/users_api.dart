...
class UsersApi {
  ...
  Future<Response<CurrentUser>> addTags({
    required String userId,
    required ChangeUserTagsRequest changeUserTagsRequest,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteAllUserPersistenceData({
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/users/{userId}/persist'.replaceAll(
      '{'
      r'userId'
      '}',
      userId.toString(),
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AgeVerificationStatusResult] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AgeVerificationStatusResult>> getAgeVerificationStatus({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/ageVerification/status';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    AgeVerificationStatusResult? _responseData;
    ...
    try {
      ...
      _responseData = rawData == null
          ...
          : deserialize<
              ...
              AgeVerificationStatusResult
            >(rawData, 'AgeVerificationStatusResult', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<AgeVerificationStatusResult>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<Group>>> getBlockedGroups({
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/users/{userId}/groups/userblocked'.replaceAll(
      '{'
      r'userId'
      '}',
      userId.toString(),
  ...
  /// Returns a [Future] containing a [Response] with a [List<Group>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<Group>>> getInvitedGroups({
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/users/{userId}/groups/invited'.replaceAll(
      '{'
      r'userId'
      '}',
      userId.toString(),
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [List<MutualFriend>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<MutualFriend>>> getMutualFriends({
    required String userId,
    int? n = 60,
    int? offset,
    CancelToken? cancelToken,
    ...
    final _path = r'/users/{userId}/mutuals/friends'.replaceAll(
      '{'
      r'userId'
      '}',
      userId.toString(),
    ...
    List<MutualFriend>? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<List<MutualFriend>, MutualFriend>(
              rawData,
              'List<MutualFriend>',
              growable: true,
            );
    ...
    return Response<List<MutualFriend>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<LimitedUserGroups>>> getMutualGroups({
    required String userId,
    int? n = 60,
    int? offset,
    CancelToken? cancelToken,
    ...
    final _path = r'/users/{userId}/mutuals/groups'.replaceAll(
      '{'
      r'userId'
      '}',
      userId.toString(),
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [Mutuals] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Mutuals>> getMutuals({
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/users/{userId}/mutuals'.replaceAll(
      '{'
      r'userId'
      '}',
      userId.toString(),
    ...
    Mutuals? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<Mutuals, Mutuals>(rawData, 'Mutuals', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  /// Parameters:
  /// * [userId] - Must be a valid user ID.
  /// * [asSelf] - Include the properties VRChat shows a user on their own profile. Ignored for any other user.
  /// * [withGroupsAndWorlds] - Include `groups`, `publicWorlds`, `totalPublicWorldsCount` and `worldFavoriteLists` in the response.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<PublicProfile>> getPublicProfile({
    ...
    final _queryParameters = <String, dynamic>{
      if (asSelf != null) r'asSelf': asSelf,
      if (withGroupsAndWorlds != null)
        r'withGroupsAndWorlds': withGroupsAndWorlds,
    };
  ...
  /// Parameters:
  /// * [userId] - Must be a valid user ID.
  /// * [groupIds] - Comma-separated (no spaces!) list of GroupIDs to retrieve permissions for.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [Map<String, List<GroupPermissions>>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Map<String, List<GroupPermissions>>>>
  getUserAllGroupPermissions({
    ...
    final _path = r'/users/{userId}/groups/permissions'.replaceAll(
      '{'
      r'userId'
      '}',
      userId.toString(),
    ...
    Map<String, List<GroupPermissions>>? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<Map<String, List<GroupPermissions>>, List>(
              rawData,
    ...
    return Response<Map<String, List<GroupPermissions>>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UserClientConfig] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserClientConfig>> getUserClientConfig({
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/users/{userId}/clientConfig'.replaceAll(
      '{'
      r'userId'
      '}',
      userId.toString(),
    ...
    UserClientConfig? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<UserClientConfig, UserClientConfig>(
              rawData,
              'UserClientConfig',
              growable: true,
            );
    ...
    return Response<UserClientConfig>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [List<Feedback>] as data
  /// Throws [DioException] if API call or serialization fails
  ...
  /// Returns a [Future] containing a [Response] with a [List<Group>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<Group>>> getUserGroupRequests({
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  ///
  /// Parameters:
  /// * [userNoteId] - Must be a valid user note ID.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserNote>> getUserNote({
    required String userNoteId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [List<UserNote>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<UserNote>>> getUserNotes({
    int? n = 60,
    int? offset,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [CurrentUser] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CurrentUser>> removeTags({
    required String userId,
    required ChangeUserTagsRequest changeUserTagsRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  ///
  /// Parameters:
  /// * [search] - Searches by `displayName`. Will return empty array if search query is empty or missing.
  ...
  /// Parameters:
  /// * [userId] - Must be a valid user ID.
  /// * [badgeId] - Must be a valid badge ID.
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> updateBadge({
    required String userId,
    required String badgeId,
    required UpdateUserBadgeRequest updateUserBadgeRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [PublicProfile] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PublicProfile>> updateProfile({
    required String userId,
  ...
  /// Returns a [Future] containing a [Response] with a [UserClientConfig] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserClientConfig>> updateUserClientConfig({
    required String userId,
    UpdateUserClientConfigRequest? updateUserClientConfigRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      _bodyData = jsonEncode(updateUserClientConfigRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
