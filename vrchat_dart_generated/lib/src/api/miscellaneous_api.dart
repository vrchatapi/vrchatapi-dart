...
class MiscellaneousApi {
  ...
  const MiscellaneousApi(this._dio);
  ...
  ///
  /// Parameters:
  /// * [betaName] - The name of a beta program.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [Beta] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Beta>> getBeta({
    ...
    final _path = r'/beta/{betaName}'.replaceAll(
      '{'
      r'betaName'
      '}',
      betaName.toString(),
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<Beta, Beta>(rawData, 'Beta', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> getBetaRegistration({
    required String betaName,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/beta/{betaName}/register'.replaceAll(
      '{'
      r'betaName'
      '}',
      betaName.toString(),
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<int>> getCurrentOnlineUsers({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<Object>>> getFrontendBranches({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/frontend/branches';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
  ...
  ///
  /// Parameters:
  /// * [require] - Tags to include (comma-separated). All of the tags needs to be present.
  /// * [include] - Tags to include (comma-separated). Any of the tags needs to be present.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Permission>> getPermission({
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DateTime>> getSystemTime({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
