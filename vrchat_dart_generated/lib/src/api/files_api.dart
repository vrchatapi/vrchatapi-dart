...
class FilesApi {
  ...
  /// Returns a [Future] containing a [Response] with a [File] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<File>> deleteFileVersion({
    required String fileId,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [FileAnalysis] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FileAnalysis>> getFileAnalysis({
    required String fileId,
    required int versionId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [FileAnalysis] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FileAnalysis>> getFileAnalysisSecurity({
    required String fileId,
    required int versionId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [FileAnalysis] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FileAnalysis>> getFileAnalysisStandard({
    required String fileId,
    required int versionId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [File] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<File>> uploadGalleryImage({
  ...
  /// Returns a [Future] containing a [Response] with a [File] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<File>> uploadIcon({
    required MultipartFile file,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  Future<Response<File>> uploadImage({
    ...
    try {
      _bodyData = FormData.fromMap(<String, dynamic>{
        if (animationStyle != null) r'animationStyle': animationStyle,
        r'file': file,
        if (frames != null) r'frames': frames,
        if (framesOverTime != null) r'framesOverTime': framesOverTime,
        if (loopStyle != null) r'loopStyle': loopStyle,
        if (maskTag != null) r'maskTag': maskTag,
        r'tag': tag,
      });
    } catch (error, stackTrace) {
      throw DioException(
