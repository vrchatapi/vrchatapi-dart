...
class PrintsApi {
  ...
  Future<Response<void>> deletePrint({
  ...
  /// * [note] - The caption for the image.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [Print] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Print>> editPrint({
    required String printId,
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<Print, Print>(rawData, 'Print', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// Returns a [Future] containing a [Response] with a [Print] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Print>> getPrint({
    required String printId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [List<Print>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<Print>>> getUserPrints({
  ...
  /// * [note] - The caption for the image.
  /// * [worldId] - The id of the world in which the image was captured.
  /// * [worldName] - The name of the world in which the image was captured.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [Print] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Print>> uploadPrint({
    required MultipartFile image,
