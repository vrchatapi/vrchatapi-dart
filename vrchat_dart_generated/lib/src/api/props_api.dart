...
class PropsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [Prop] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Prop>> createProp({
    required CreatePropRequest createPropRequest,
    ...
    try {
      _bodyData = jsonEncode(createPropRequest);
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<Prop, Prop>(rawData, 'Prop', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteProp({
    ...
    final _path = r'/props/{propId}'.replaceAll(
      '{'
      r'propId'
      '}',
      propId.toString(),
  ...
  Future<Response<PropPublishStatus>> getPropPublishStatus({
    ...
    final _path = r'/props/{propId}/publish'.replaceAll(
      '{'
      r'propId'
      '}',
      propId.toString(),
    ...
    PropPublishStatus? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<PropPublishStatus, PropPublishStatus>(
              rawData,
              'PropPublishStatus',
              growable: true,
            );
    ...
    return Response<PropPublishStatus>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<List<Prop>>> listProps({
    ...
    List<Prop>? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<List<Prop>, Prop>(
              rawData,
              'List<Prop>',
              growable: true,
            );
  ...
  /// Returns a [Future] containing a [Response] with a [Prop] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Prop>> updateProp({
    required String propId,
    required UpdatePropRequest updatePropRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      _bodyData = jsonEncode(updatePropRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
