...
import 'package:vrchat_dart_generated/src/model/sort_option_product_purchase.dart';
...
class EconomyApi {
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProductListing>> createProductListingDirect({
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SuccessFlag>> deleteProduct({
    ...
    final _path = r'/products/{productId}'.replaceAll(
      '{'
      r'productId'
      '}',
      productId.toString(),
  ...
  /// Returns a [Future] containing a [Response] with a [SuccessFlag] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SuccessFlag>> deleteProductListingDirect({
    required String productId,
    bool? hydrate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<Object>>> getBulkGiftPurchases({
    bool? mostRecent,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/user/bulk/gift/purchases';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    final _queryParameters = <String, dynamic>{
      if (mostRecent != null) r'mostRecent': mostRecent,
    };
  ...
  Future<Response<EarningsMetrics>> getEarningsMetrics({
    ...
    final _path = r'/economy/metrics/earnings';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    EarningsMetrics? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<EarningsMetrics, EarningsMetrics>(
              rawData,
              'EarningsMetrics',
              growable: true,
            );
    ...
    return Response<EarningsMetrics>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EconomyBalances] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EconomyBalances>> getEconomyBalances({
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/user/{userId}/economy/balances'.replaceAll(
      '{'
      r'userId'
      '}',
      userId.toString(),
    ...
    EconomyBalances? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<EconomyBalances, EconomyBalances>(
              rawData,
              'EconomyBalances',
              growable: true,
            );
    ...
    return Response<EconomyBalances>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EconomyPayoutStatus] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EconomyPayoutStatus>> getEconomyPayoutStatus({
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/user/{userId}/economy/payouts/status'.replaceAll(
      '{'
      r'userId'
      '}',
      userId.toString(),
    ...
    EconomyPayoutStatus? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<EconomyPayoutStatus, EconomyPayoutStatus>(
              rawData,
              'EconomyPayoutStatus',
              growable: true,
            );
    ...
    return Response<EconomyPayoutStatus>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EconomyPayoutList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EconomyPayoutList>> getEconomyPayouts({
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/user/{userId}/economy/payouts/list'.replaceAll(
      '{'
      r'userId'
      '}',
      userId.toString(),
    ...
    EconomyPayoutList? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<EconomyPayoutList, EconomyPayoutList>(
              rawData,
              'EconomyPayoutList',
              growable: true,
            );
    ...
    return Response<EconomyPayoutList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  @Deprecated('This operation has been deprecated')
  Future<Response<ProductListing>> getProductListingAlternate({
    required String productId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [hydrate] - Populates some fields and changes types of others for certain objects.
  /// * [listingType] - Filter user listings by category. Observed values include `otp` and `subscription`.
  ...
  ///
  /// Parameters:
  /// * [productPurchaseId] - Must be a valid purchase ID.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ProductPurchase] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProductPurchase>> getProductPurchase({
    required String productPurchaseId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/economy/purchases/{productPurchaseId}'.replaceAll(
      '{'
      r'productPurchaseId'
      '}',
      productPurchaseId.toString(),
    );
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
    ...
    ProductPurchase? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<ProductPurchase, ProductPurchase>(
              rawData,
              'ProductPurchase',
              growable: true,
            );
    ...
    return Response<ProductPurchase>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [userId] - Must be a valid user ID.
  /// * [n] - The number of objects to return.
  /// * [dateMin] - The start date of the search range.
  /// * [dateMax] - The end date of the search range.
  /// * [fromUserId] - Must be a valid user ID.
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ProductPurchaseHistory] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProductPurchaseHistory>> getProductPurchaseHistory({
    required String userId,
    int? n = 60,
    DateTime? dateMin,
    DateTime? dateMax,
    String? fromUserId,
    String? toUserId,
    SortOptionProductPurchase? sort,
    OrderOptionShort? order,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/user/{userId}/economy/transactions'.replaceAll(
      '{'
      r'userId'
      '}',
      userId.toString(),
    ...
    final _queryParameters = <String, dynamic>{
      if (n != null) r'n': n,
      if (dateMin != null) r'dateMin': dateMin,
      if (dateMax != null) r'dateMax': dateMax,
      if (fromUserId != null) r'fromUserId': fromUserId,
    ...
    ProductPurchaseHistory? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<ProductPurchaseHistory, ProductPurchaseHistory>(
              rawData,
    ...
    return Response<ProductPurchaseHistory>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [List<Object>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<Object>>> getProductPurchaseStacks({
    required String productPurchaseId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/economy/purchases/{productPurchaseId}/stacks'.replaceAll(
      '{'
      r'productPurchaseId'
      '}',
      productPurchaseId.toString(),
  ...
  Future<Response<List<ProductPurchase>>> getProductPurchases({
    ...
    final _path = r'/economy/purchases';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    List<ProductPurchase>? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<List<ProductPurchase>, ProductPurchase>(
              rawData,
    ...
    return Response<List<ProductPurchase>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<UserSubscription>> getRecentSubscription({
    ...
    final _path = r'/user/subscription/recent';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<UserSubscription, UserSubscription>(
              rawData,
              'UserSubscription',
              growable: true,
            );
  ...
  Future<Response<SellerEligibility>> getSellerEligibility({
    ...
    final _path = r'/economy/seller/eligibility';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<SellerEligibility, SellerEligibility>(
              rawData,
              'SellerEligibility',
              growable: true,
            );
    ...
    return Response<SellerEligibility>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<UserCreditsEligible>> getUserCreditsEligible({
    ...
    final _path = r'/users/{userId}/credits/eligible'.replaceAll(
      '{'
      r'userId'
      '}',
      userId.toString(),
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<UserCreditsEligible, UserCreditsEligible>(
              rawData,
              'UserCreditsEligible',
              growable: true,
            );
    ...
    return Response<UserCreditsEligible>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [TiliaKyc] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TiliaKyc>> getUserTiliaKyc({
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/user/{userId}/tilia/kyc'.replaceAll(
      '{'
      r'userId'
      '}',
      userId.toString(),
    ...
    TiliaKyc? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<TiliaKyc, TiliaKyc>(
              rawData,
              'TiliaKyc',
              growable: true,
            );
  ...
  Future<Response<List<Store>>> listStores({
    ...
    List<Store>? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<List<Store>, Store>(
              rawData,
              'List<Store>',
              growable: true,
            );
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<Product>>> listUserProducts({
    required String userId,
    int? n = 60,
    int? offset,
    CancelToken? cancelToken,
    ...
    final _path = r'/user/{userId}/products'.replaceAll(
      '{'
      r'userId'
      '}',
      userId.toString(),
  ...
  /// Returns a [Future] containing a [Response] with a [ProductPurchase] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProductPurchase>> purchaseProductListing({
    ...
    final _path = r'/economy/purchase/listing';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    try {
      _bodyData = jsonEncode(purchaseProductListingRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
  ...
  /// Returns a [Future] containing a [Response] with a [ProductListing] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProductListing>> updateProductListingDirect({
    required String productId,
  ...
  Future<Response<Object>> updateTiliaTos({
    ...
    try {
      _bodyData = jsonEncode(updateTiliaTOSRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
